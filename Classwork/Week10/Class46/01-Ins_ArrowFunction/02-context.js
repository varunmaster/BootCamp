...
var person = {
  ...
  saySomething: function() {
    ...
    setTimeout(function() {
      console.log(this.name + "!"); //"this" loses scope here and so "this" is undefined
    }, 100);
  }
};
...
var person = {
  ...
  saySomething: function() {
    console.log(this.name + " is thinking...");
    setTimeout(() => console.log(this.name + "!"), 100); //"this" is used in an arrow function so "this" is now passed in from the parent (aka person.name) and it knows what "this" is referring to
  }
};
