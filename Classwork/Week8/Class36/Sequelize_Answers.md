...
* Spend the next few ~15 minutes with your partner answering the following questions. You should be using the Sequelize Documentation (and whatever other references you find online).
  ...
  * Let's say I have the below table in MySQL.
    ...
    * Question: How would I model it in Sequelize? -- This is saying how do I create a new table
      ...
      {
        freezeTableName: true // Model tableName will be the same as the model name instead of being pluralized. usually the table name is plural and individual record is singular
      });
