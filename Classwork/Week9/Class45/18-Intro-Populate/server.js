...
// Require all models
var db = require("./models"); //here we are connecting the two collections together
...
app.use(express.static("public")); //anything for front-end browser should be put here
...
app.post("/submit", function(req, res) {
  ...
  db.Book.create(req.body)
    .then(function(dbBook) {
      ...
      //we use $push because its an array of books that library has and we are adding a new book to it
    })
    .then(function(dbLibrary) {
...
app.get("/populated", function(req, res) {
  ...
  db.Library.find({})
    ...
    .populate("books") //we are joining the Library model and the Books model
    .then(function(dbLibrary) {
