...
var ExampleSchema = new Schema({
  ...
  email: {
    type: String,
    match: [/.+@.+\..+/, "Please enter a valid e-mail address"] //. -> any character; + -> one or more; \. -> literal dot
  },
...
var Example = mongoose.model("Example", ExampleSchema); //"Example" will be the name of the model. 
