...
## Phase I - For this first phase, aim to write out the pieces that will need to be programmed to create lslthe functionality of your application. Try to break it into 6-7 pieces
